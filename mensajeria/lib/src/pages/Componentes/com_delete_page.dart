...
class ComDelete extends StatefulWidget {
  final name;
...
class _HomePageState extends State<ComDelete> {
  ...
  Future<List<Miembro>> fetchNotes() async {
    ...
    var url = '${AppConfig.apiHost}/getComCha.php';
  ...
  void _deleteCanal(canalP, usuarioP) async {
    var url = "${AppConfig.apiHost}/deleteCanales.php";
              ...
              children: <Widget>[
                ...
                Center(
                  child: CupertinoButton(
                    ...
                    onPressed: () {
                      _deleteCanal(canal, _notesForDisplay[index].usuario);
                      fetchNotes().then((value) {
                        setState(() {
                          _notes.clear();
